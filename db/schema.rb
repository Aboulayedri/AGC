...
ActiveRecord::Schema.define(version: 20140213073157) do
  ...
  add_index "collaborators", ["reset_password_token"], name: "index_collaborators_on_reset_password_token", unique: true
