...
describe ProjectCodesController do
  ...
  # ProjectCodesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested project_code as @project_code" do
      project_code = ProjectCode.create! valid_attributes
      get :show, {:id => project_code.to_param}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created project_code" do
        post :create, {:project_code => valid_attributes}, valid_session
        response.should redirect_to(ProjectCode.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved project_code as @project_code" do
        ...
        post :create, {:project_code => { "name" => "invalid value" }}, valid_session
        assigns(:project_code).should be_a_new(ProjectCode)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested project_code" do
        ...
        ProjectCode.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => project_code.to_param, :project_code => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the project_code" do
        project_code = ProjectCode.create! valid_attributes
        put :update, {:id => project_code.to_param, :project_code => valid_attributes}, valid_session
        response.should redirect_to(project_code)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the project_code as @project_code" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ProjectCode.any_instance.stub(:save).and_return(false)
        put :update, {:id => project_code.to_param, :project_code => { "name" => "invalid value" }}, valid_session
        assigns(:project_code).should eq(project_code)
      end
