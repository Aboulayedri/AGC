...
describe CollaboratorsController do
  ...
  let(:valid_attributes) { { "prenom" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved collaborator as @collaborator" do
        ...
        post :create, {:collaborator => { "prenom" => "invalid value" }}, valid_session
        assigns(:collaborator).should be_a_new(Collaborator)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested collaborator" do
        ...
        Collaborator.any_instance.should_receive(:update).with({ "prenom" => "MyString" })
        put :update, {:id => collaborator.to_param, :collaborator => { "prenom" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the collaborator as @collaborator" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Collaborator.any_instance.stub(:save).and_return(false)
        put :update, {:id => collaborator.to_param, :collaborator => { "prenom" => "invalid value" }}, valid_session
        assigns(:collaborator).should eq(collaborator)
      end
